---
title: "Claude Code Context Engineering 深度解析：把 token 花在刀刃上"
subtitle: "窗口有限，注意力更有限——把每一段上下文都变成有效信息"
description: "深入 Claude Code 的上下文管理机制：token 预算规划、缓存命中策略、PreCompact 状态抢救、渐进式披露设计、上下文防污染。不是教你怎么省 token——是教你怎么把 token 花出最大价值。"
date: 2026-06-21 21:04:00+08:00
lastmod: 2026-06-21 21:04:00+08:00
...
tags: ["tech", "ai", "claude code", "context engineering", "token budget", "prompt caching"]
