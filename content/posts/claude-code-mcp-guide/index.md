---
title: "Claude Code MCP 完全指南：给你的 AI 造工具"
subtitle: "一个协议，三要素（Tool/Resource/Prompt），用自定义 MCP Server 扩展 Claude Code 的能力边界"
description: "深入 MCP（Model Context Protocol）：从协议原理到动手写一个 MCP Server，从市场生态选型到五层安全防御。读完你会理解 MCP 为什么是 Claude Code 四层架构的最后一块基石，以及怎么自己造。"
date: 2026-06-10 20:48:00+08:00
lastmod: 2026-06-10 20:48:00+08:00
...
tags: ["tech", "ai", "claude code", "mcp", "development tools"]
