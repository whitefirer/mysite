---
title: "Prompt Caching 深度解析：插件 + 缓存 = 98% 费用节省"
subtitle: "DeepSeek V4 架构如何把缓存折扣做到 120 倍"
description: "拆解两层省钱机制——插件砍 token 量（省 97%），Prompt Caching 砍单价（多省 46%）。深入 DeepSeek V4 Pro 的三池异构 KV Cache 架构和 ShadowRadix 前缀复用系统，解析 120 倍缓存折扣的底层原理。"
date: 2026-05-03 22:15:00+08:00
lastmod: 2026-05-04 22:00:00+08:00
slug: "prompt-caching-deepseek"
author: "whitefirer"
...
tags: ["tech", "ai", "prompt caching", "deepseek", "claude code", "cost optimization"]
categories: ["Tech"]
toc:
    auto: false
---
